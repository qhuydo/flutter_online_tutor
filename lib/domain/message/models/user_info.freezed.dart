...
class _$UserInfoTearOff {
  ...
  _UserInfo call({required String id, required String name}) {
    return _UserInfo(
      id: id,
      name: name,
    );
...
class _$_UserInfo extends _UserInfo {
  const _$_UserInfo({required this.id, required this.name}) : super._();
...
abstract class _UserInfo extends UserInfo {
  const factory _UserInfo({required String id, required String name}) =
      _$_UserInfo;
