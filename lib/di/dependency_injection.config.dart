...
import '../application/common/app/app_cubit.dart' as _i7;
import '../domain/common/app/i_app_repository.dart' as _i3;
import '../infrastructure/common/app/app_repository.dart' as _i4;
import '../infrastructure/common/db/shared_preference_storage.dart' as _i5;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i5.SharedPreferenceStorage>(
      () => _i5.SharedPreferenceStorageImpl());
  await gh.factoryAsync<_i6.SharedPreferences>(() => appInjectableModule.prefs,
      preResolve: true);
  gh.factory<_i7.AppCubit>(
      () => _i7.AppCubit(appRepository: get<_i3.AppRepository>()));
  return get;
}

class _$AppInjectableModule extends _i8.AppInjectableModule {}
