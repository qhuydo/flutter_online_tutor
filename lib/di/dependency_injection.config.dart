...
import '../application/authentication/reset_password/reset_password_bloc.dart'
    as _i20;
import '../application/authentication/sign_up/sign_up_bloc.dart' as _i21;
...
import '../infrastructure/common/di/app_injectable_module.dart' as _i23;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i20.ResetPasswordBloc>(
      () => _i20.ResetPasswordBloc(get<_i15.AuthenticationService>()));
  gh.factory<_i21.SignUpBloc>(
      () => _i21.SignUpBloc(get<_i15.AuthenticationService>()));
  gh.factory<_i22.AuthenticationBloc>(
      () => _i22.AuthenticationBloc(get<_i15.AuthenticationService>()));
  return get;
}
