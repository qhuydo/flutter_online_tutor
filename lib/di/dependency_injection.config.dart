...
import '../application/authentication/sign_up/sign_up_bloc.dart' as _i12;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i12.SignUpBloc>(
      () => _i12.SignUpBloc(get<_i9.AuthenticationService>()));
  gh.factory<_i13.AuthenticationBloc>(
      () => _i13.AuthenticationBloc(get<_i9.AuthenticationService>()));
  return get;
}

class _$AppInjectableModule extends _i14.AppInjectableModule {}
