...
import '../application/authentication/authentication_bloc.dart' as _i44;
import '../application/authentication/change_password/change_password_bloc.dart'
    as _i32;
import '../application/authentication/login/login_bloc.dart' as _i37;
import '../application/authentication/reset_password/reset_password_bloc.dart'
    as _i40;
import '../application/authentication/sign_up/sign_up_bloc.dart' as _i42;
...
import '../application/schedule/history/history_bloc.dart' as _i36;
...
import '../application/tutor/recommended_tutors/recommended_tutors_bloc.dart'
    as _i39;
import '../application/tutor/search_tutors/search_tutors_bloc.dart' as _i41;
import '../application/tutor/tutor_details/tutor_details_bloc.dart' as _i43;
import '../application/user/profile/profile_bloc.dart' as _i38;
...
import '../infrastructure/common/di/app_injectable_module.dart' as _i46;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i35.DioInterceptor>(() =>
      _i35.DioInterceptor(get<_i8.Dio>(), get<_i30.AuthenticationService>()));
  gh.factory<_i36.HistoryBloc>(
      () => _i36.HistoryBloc(get<_i14.ScheduleRepository>()));
  gh.factory<_i37.LoginBloc>(
      () => _i37.LoginBloc(get<_i30.AuthenticationService>()));
  gh.factory<_i38.ProfileBloc>(() => _i38.ProfileBloc(
      get<_i30.AuthenticationService>(), get<_i26.UserRepository>()));
  gh.factory<_i39.RecommendedTutorsBloc>(
      () => _i39.RecommendedTutorsBloc(get<_i22.TutorRepository>()));
  gh.factory<_i40.ResetPasswordBloc>(
      () => _i40.ResetPasswordBloc(get<_i30.AuthenticationService>()));
  gh.factory<_i41.SearchTutorsBloc>(
      () => _i41.SearchTutorsBloc(get<_i22.TutorRepository>()));
  gh.factory<_i42.SignUpBloc>(
      () => _i42.SignUpBloc(get<_i30.AuthenticationService>()));
  gh.factory<_i43.TutorDetailsBloc>(
      () => _i43.TutorDetailsBloc(get<_i22.TutorRepository>()));
  gh.factory<_i44.AuthenticationBloc>(
      () => _i44.AuthenticationBloc(get<_i30.AuthenticationService>()));
  gh.singleton<_i30.AuthenticationService>(
      _i45.AuthenticationServiceImpl(
          get<_i5.Box<String>>(instanceName: 'secret'), get<_i28.ApiClient>()),
      registerFor: {_dev, _prod, _test});
  return get;
}

class _$AppInjectableModule extends _i46.AppInjectableModule {}
